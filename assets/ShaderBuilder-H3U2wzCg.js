import{r as m,A as _}from"./index-D4B0nWYv.js";const p=()=>_.getLogger("esri.views.3d.webgl-engine.core.shaderModules.shaderBuilder");class b{constructor(){this._includedModules=new Map}include(e,n){this._includedModules.has(e)?this._includedModules.get(e):(this._includedModules.set(e,n),e(this.builder,n))}}class U extends b{constructor(){super(...arguments),this.vertex=new g,this.fragment=new g,this.attributes=new A,this.varyings=new F,this.outputs=new l}get attributeNames(){return this.attributes.names}get builder(){return this}generate(e,n=!1){const t=this.attributes.generateSource(e),s=this.varyings.generateSource(e),i=e==="vertex"?this.vertex:this.fragment,a=i.uniforms.generateSource(),u=i.code.generateSource(),h=i.main.generateSource(n),d=this.debugName?`// ${this.debugName}
`:"",f=e==="vertex"?D:E,$=i.constants.generateSource(),S=this.outputs.generateSource(e);return`#version 300 es
${d}
${f}
${$.join(`
`)}
