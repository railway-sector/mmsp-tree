...
color.a = noPerspectiveRead(color.a);`),h&&r.uniforms.add(new ke("innerColor",u=>u.innerColor??u.color),new Y("innerWidth",(u,L)=>u.innerWidth*L.camera.pixelRatio)).main.add(s`float distToInner = abs(lineDistance) - innerWidth;
