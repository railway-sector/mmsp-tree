import{n as T,cS as pe,ji as za,f8 as Fa,gn as Pa,k1 as $a,fh as ce,jS as ja,sm as Oa,kW as Ra,AQ as Rt,cA as Wt,ae as c,ag as G,ah as j,AR as Wa,AS as Na,dC as Nt,jv as Qe,jD as de,jY as yt,jQ as Ea,oP as wt,m$ as K,kX as X,hY as et,_ as B,hq as ge,eL as Ga,eN as Ba,dp as Et,jd as La,rq as Gt,dX as Va,A2 as E,ij as Aa,iR as We,fN as Ha,cU as Ua,cI as ka,fe as Ne,fi as Za,ff as Mt,cF as qa,hj as Ja,cw as Ya}from"./index-Bm7M9SKb.js";import{L as R,aw as N,g as Bt,ax as Ie,ay as Lt,az as Vt,a9 as we,aA as Xa,aB as Ka,M as Qa,aC as se,K as x,P as At,f as U,aD as k,u as le,O as w,h as Z,R as eo,d as to,aE as Ht,ae as W,aF as De,E as tt,i as Q,t as L,Q as O,C as ze,aa as Me,aG as ao,a8 as ue,aH as oo,y as Fe,aI as io,D as Se,e as Ut,aJ as kt,x as at,b as Zt,k as ro,l as no,o as so,z as lo,j as co,r as uo,n as ho,p as mo,s as po,aK as Ee,_ as fo}from"./OutputColorHighlightOLID.glsl-CtMKq1PO.js";import{t as vo,c as Pe,a as ee,i as go,r as ot,n as qt,b as xo}from"./BooleanBindUniform-BIdJUvbx.js";import{o as q,i as bo,r as Jt,s as yo,m as wo,e as Mo}from"./VertexColor.glsl-DRCHui4C.js";import{a as So,c as Yt,d as it,o as fe,u as Xt,b as J,f as rt,_ as To,e as _o,n as Kt,O as Co}from"./MixExternalColor.glsl-DMWdSvhY.js";import{t as Ue,Q as nt}from"./InterleavedLayout-BuaWo5U8.js";import{i as $,L as Qt,Q as Te,J as St}from"./BufferView-DOY2yBGz.js";import{r as Io}from"./VertexBuffer-zbq51q6X.js";import{g as Do}from"./mathUtils-DN1O2xtI.js";import{O as te,g as ae,_ as zo}from"./renderState-DsaPcst1.js";import{t as i,n as v,b as Fo,i as p,a as ea}from"./oitResolution.glsl-DPeF3_rU.js";import{s as V}from"./ShaderBuilder-CQa-oyzE.js";import{c as A}from"./NoParameters-DB-WZ6gy.js";function $e(t,e){switch(t.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
gl_FragDepth = _linearDepth;
        ...
        color.a = 1.0;
      `);break;case 4:break;default:e.alphaDiscardMode}o.code.add("}")}function sa(t,e){const{vertex:a,fragment:o,varyings:r}=t,{hasColorTexture:n,alphaDiscardMode:l}=e,s=n&&l!==1,{output:d,normalType:u,hasColorTextureTransform:h}=e;switch(d){case 3:U(a,e),t.include(q),o.include(Z,e),t.include(k,e),s&&o.uniforms.add(new w("tex",g=>g.texture)),a.main.add(i`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`),t.include(Y,e),o.main.add(i`
        ...
        ${v(s,i`vec4 texColor = texture(tex, ${h?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 5:case 6:case 7:case 8:case 11:U(a,e),t.include(q),t.include(k,e),t.include(le,e),t.include(ko,e),o.include(Z,e),t.include(to,e),bo(t),r.add("depth","float",{invariant:!0}),s&&o.uniforms.add(new w("tex",g=>g.texture)),a.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),t.include(Y,e),o.main.add(i`
        ...
        ${d===11?i`outputObjectAndLayerIdColor();`:i`outputDepth(depth);`}`);break;case 4:{U(a,e),t.include(q),t.include($e,e),t.include(ta,e),t.include(k,e),t.include(le,e),s&&o.uniforms.add(new w("tex",m=>m.texture)),u===2&&r.add("vPositionView","vec3",{invariant:!0});const g=u===0||u===1;a.main.add(i`
        ...
        fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case 10:U(a,e),t.include(q),t.include(k,e),t.include(le,e),s&&o.uniforms.add(new w("tex",g=>g.texture)),a.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),o.include(Z,e),t.include(Y,e),t.include(eo,e),o.main.add(i`
        ...
        ${v(s,i`vec4 texColor = texture(tex, ${h?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
        calculateOcclusionAndOutputHighlight();`)}}function qo(t,e){return Jo(t,e)}function Jo(t,e){const a=t.fragment,{hasVertexTangents:o,doubleSidedMode:r,hasNormalTexture:n,textureCoordinateType:l,bindType:s,hasNormalTextureTransform:d}=e;o?(t.attributes.add("tangent","vec4"),t.varyings.add("vTangent","vec4"),r===2?a.code.add(i`mat3 computeTangentSpace(vec3 normal) {
...
return linearizeDepth(depthFromTexture(depthTexture, uv), zProjectionMapLastFrame);
  ...
  `),t}const ma=new Fo;ma.useFloatBlend=!1;const Di=Object.freeze(Object.defineProperty({__proto__:null,GlobalIlluminationBlurDrawParameters:vt,build:ha},Symbol.toStringTag,{value:"Module"}));let qe=class extends Q{constructor(){super(...arguments),this.shader=new L(Di,()=>B(()=>Promise.resolve().then(()=>hr),void 0))}initializePipeline(){return te({colorWrite:ae})}};qe=c([j("esri.views.3d.webgl-engine.effects.globalIllumination.GlobalIlluminationBlurTechnique")],qe);let Je=class extends Q{constructor(){super(...arguments),this.shader=new L(Ti,()=>B(()=>Promise.resolve().then(()=>mr),void 0))}initializePipeline(){return te({colorWrite:ae})}};Je=c([j("esri.views.3d.webgl-engine.effects.globalIllumination.GlobalIlluminationTechnique")],Je);let Ye=class extends ea{constructor(){super(...arguments),this.hasColor=!0,this.hasEmission=!1,this.rayMarchMaxReach=Oe,this.rayMarchMaxSteps=Re,this.useProjectedRayLength=!0,this.clampRayToScreen=!1}};c([p()],Ye.prototype,"hasColor",void 0),c([p()],Ye.prototype,"hasEmission",void 0);const jt=5e4,zi=100;let gt=class extends A{};function pa(){const t=new V,e=t.fragment;return t.include(fe),t.include(Pe),t.include(ua),e.include(ee),e.include(ct),e.uniforms.add(new w("depthMap",a=>a.depthTexture),new w("normalMap",a=>a.normalTexture),new W("tex",a=>a.colorTexture),new W("globalIlluminationWeightTexture",a=>a.weightTexture),new x("projScale",(a,o)=>{const r=o.camera.distance;return r>jt?Math.max(0,a.projScale-(r-jt)):a.projScale})),e.code.add(i`
...
}`)):t.vertex.code.add(i`void forwardOcclusionUV(){}`)}function Ji(t,e){e.hasMetallicRoughnessTextureTransform&&e.textureCoordinateType!==0?(t.varyings.add("metallicRoughnessUV","vec2"),t.vertex.uniforms.add(new N("metallicRoughnessTextureTransformMatrix",a=>a.metallicRoughnessTextureTransformMatrix??K)).code.add(i`void forwardMetallicRoughnessUV(){
...
}`))}function Ta(t){const e=new V,{attributes:a,vertex:o,fragment:r,varyings:n}=e,{output:l,normalType:s,offsetBackfaces:d,spherical:u,snowCover:h,pbrMode:g,textureAlphaPremultiplied:m,instancedDoublePrecision:_,hasVertexColors:b,hasVertexTangents:C,hasColorTexture:I,hasNormalTexture:P,hasNormalTextureTransform:D,hasColorTextureTransform:z}=t;if(U(o,t),a.add("position","vec3"),o.inputs.add("position",()=>"position"),n.add("vpos","vec3",{invariant:!0}),e.include(le,t),e.include(ra,t),e.include(qt,t),e.include(wa,t),!Fe(l))return e.include(sa,t),e;e.include(Zi,t),e.include(Ma,t),e.include(qi,t),e.include(Ji,t),Se(o,t),e.include($e,t),e.include(q);const M=s===0||s===1;return M&&d&&e.include(oa),e.include(qo,t),e.include(ta,t),e.include(ia,t),n.add("vPositionLocal","vec3"),e.include(k,t),e.include(na,t),e.include(Jt,t),o.uniforms.add(new Ut("externalColor",y=>y.externalColor,{supportsNaN:!0})),n.add("vcolorExt","vec4"),o.include(Ie),o.include(kt),e.include(_?xa:ba,t),o.main.add(i`
    forwardVertexColor();
